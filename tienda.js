...
export class TiendaHTML {
      ...
      crearTienda(){
            this.carrito.productos.forEach((product, index)=> { //uso arrow function para pasar el contexto de la clase. Sinó no podria acceder a las propiedades de esta misma.
                ...
                // Add Content
                nodoUnity.innerText =  this.carrito.productos[index]['price']+this.carrito.currency;
                // Add Class
                ...
                nodoTotal.innerText= this.carrito.obtenerProductoPrecioTotal(this.carrito.productos[index].SKU)+this.carrito.currency;
                ...
                /*Separator*/
                if (index < (this.carrito.productos.length - 1)) {
